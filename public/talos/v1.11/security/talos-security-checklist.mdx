...
To stay secure and up to date, make sure you upgrade regularly. You can upgrade individual nodes wit
...
- Enable etcd snapshots to capture the state of your cluster.
...
- [Certificate Authority Rotation](../build-and-extend-talos/cluster-operations-and-maintenance/disaster-recovery)
- [Generating a Secrets Bundle](../build-and-extend-talos/cluster-operations-and-maintenance/etcd-maintenance)
- [Talos Certificate Management](../../../omni/cluster-management/etcd-backups)
...
- [Audit Logs](../build-and-extend-talos/cluster-operations-and-maintenance/disaster-recovery)
- [Logging](../build-and-extend-talos/cluster-operations-and-maintenance/etcd-maintenance)
- [Deploy Metrics Server](../../../omni/cluster-management/etcd-backups)
